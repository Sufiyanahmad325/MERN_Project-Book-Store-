      ...
      <div className="navbar">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow dark:bg-slate-700   ">
                {navItems}
            </ul>
          </div>
        ...
        <div className="navbar-end space-x-3">
          ...
          {/* theme btn dark mood night mood */}
          ...
          <div>
            <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-100 cursor-pointer">Login</a>
          </div>
        </div>
      </div>
    </div>
